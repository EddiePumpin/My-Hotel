...
!developmentChains.includes(network.name)
  ...
  : describe("MegaEth Unit Test", function () {
      ...
      beforeEach(async function () {
        ...
        const fundMeDeployment = await deployments.get("MegaERC20")
        // Getting the contract address
        deployer = fundMeDeployment.address
        methERC20 = await ethers.getContractAt("MegaERC20", deployer)
        console.log({
      ...
      describe("allowances", () => {
        ...
        beforeEach(async () => {
          playerToken = await ethers.getContractAt("MegaERC20", deployer)
        })
